 ...
 */
public class SearchGoalAdapter extends BaseAdapter {


    private Context  mContext;
    private List<SearchBean.ProductListBean> mDatas;

    public SearchGoalAdapter(Context mContext, List<SearchBean.ProductListBean> mDatas) {
        mContext = mContext;
        this.mDatas = mDatas;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(parent.getContext()).load(BaseUrl.basUrl + itemBean.getPic())
